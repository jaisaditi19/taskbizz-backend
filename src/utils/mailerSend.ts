...
const sentFrom = new Sender("no-reply@taskbizz.com", "TaskBizz");
...
export async function sendTaskEmail({
  ...
  if (attachments.length) {
    ...
    (emailParams as any).attachments = mapped;
  }
...
export const sendInviteEmail = async (
  ...
  const recipients = [new Recipient(to, name || to)];
      ...
      <div style="padding:24px;">
        ...
        <table style="width:100%; border-collapse:collapse; margin:16px 0;">
          ...
          <tr>
            ...
            <td style="padding:8px; border-bottom:1px solid #e5e7eb; font-weight:bold;">${currency} ${amount.toFixed(
    2
  )}</td>
          </tr>
          <tr>
