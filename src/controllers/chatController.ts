...
export function attachChatIO(io: Server) {
  ioRef = io;
}

// Helpers
function assertBodyHasOneOf(body?: string, attachments?: any[]): boolean {
...
export const listConversations = async (req: Request, res: Response) => {
  try {
    const { id: userId, orgId } = (req.user as any) ?? {};
...
async function ensureMember(prisma: any, conversationId: string, userId: string) {
...
export const upsertDirectoryUser = async (req: Request, res: Response) => {
  try {
